...
## Enterprise 7.0 Clean
- Ren, komplett kodebase basert på Performance Rewrite.
- Mottaker: post.wood@moelven.no.
- Kategoriheaderne bruker de fem opplastede trelastbildene.
- Fjernet oransje bokstavikoner.
- Fjernet grå produktundertekst på produktknappene.
- Beholder arkiv, statistikk, modulregler, halvplassregel, Outlook, e-postapp og raskt lengdepanel.
